...
public class CalculatorOperationsTest extends TestBase {
	...
	public void calcDiffOperationsTest() throws InterruptedException, IOException {
		...
		for (int i = 2; i <= rowCount; i++) {
			...
			int testdataNum = excelOps.getRowNumber("testdata", "Sr_No", testdataNo);

			System.out.println("testdataNum---" + testdataNum);
			String firstNumber = excelOps.getCellData("testdata", "FirstNumber", testdataNum);

			String secondNumber = excelOps.getCellData("testdata", "SecondNumber", testdataNum);
			...
			if (excelOps.getCellData("execution", "TestCase", i).contains("Add")) {
				...
				logger.pass(firstNumber + " " + " + " + secondNumber + "=" + addValue + " Operation is Sucessful");
				...
				logger.pass(firstNumber + " " + " - " + secondNumber + "=" + subValue + " Operation is Sucessful");
				...
				logger.pass(firstNumber + " " + " / " + secondNumber + "=" + divValue + " Operation is Sucessful");
				...
				logger.pass(firstNumber + " " + " * " + secondNumber + "=" + mulValue + " Operation is Sucessful");
			}
